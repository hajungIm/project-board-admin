package com.springstudy.projectboardadmin.domain;

import com.springstudy.projectboardadmin.domain.constant.RoleType;
import com.springstudy.projectboardadmin.domain.converter.RoleTypesConverter;
...
public class AdminAccount extends AuditingFields {
    ...
    private Set<RoleType> roleTypes = new LinkedHashSet<>(); // "1,2,3" -> table_column
