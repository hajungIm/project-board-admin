...
class JpaRepositoryTest {
    ...
    void givenUserAccountAndRoleType_whenUpdating_thenWorksFine() {
        // Given
        AdminAccount adminAccount = adminAccountRepository.getReferenceById("ihj");
        ...
        assertThat(updatedAccount)
                .hasFieldOrPropertyWithValue("userId", "ihj")
    ...
    static class TestJpaConfig {
        @Bean
        AuditorAware<String> auditorAware() { return () -> Optional.of("test"); }
    }
