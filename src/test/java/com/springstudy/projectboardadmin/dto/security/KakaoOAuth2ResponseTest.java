package com.springstudy.projectboardadmin.dto.security;
...
class KakaoOAuth2ResponseTest {
    ...
    void givenMapFromJson_whenInstantiating_thenReturnsKakaoResponseObject() throws JsonProcessingException {
        ...
        String serializedResponse = """
                {
                    "id": 1234567890,
                    "connected_at": "2023-01-11T00:11:23Z",
                    "properties": {
                        "nickname": "홍길동"
                    },
                    "kakao_account": {
        ...
        assertThat(result)
                ...
                .hasFieldOrPropertyWithValue("connectedAt", ZonedDateTime.of(2023, 1, 11, 0, 11, 23, 0, ZoneOffset.UTC)
